...
class User extends Db_object {
    ...
    protected static $db_table_fields = array('username', 'password', 'first_name', 'last_name', 'filename');  // We don't want to include keys that is not integer(id) or irelevant to User instance($db_table)
    public $id;
    public $username;
    public $password;
    public $first_name;
