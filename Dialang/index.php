                ...
                <div class='col-md-2 sideprofile'>
                    <div class='bg-light text-center bung'>
                        <ul style='margin-top: 70px;'>
                            <li>SOME THING HERE FOR PEOPLE WHO HAVEN'T LOGGED IN SOME THING HERE FOR PEOPLE WHO HAVEN'T LOGGED IN SOME THING HERE FOR PEOPLE WHO HAVEN'T LOGGED IN</li>
                        </ul>
                    </div>
                </div>";
        }
